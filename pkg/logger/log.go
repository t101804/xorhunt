...
import (
	...
	"github.com/t101804/xorhunt/pkg/logger/formatter"
	"github.com/t101804/xorhunt/pkg/logger/levels"
	"github.com/t101804/xorhunt/pkg/logger/writer"
)
...
// Info writes a info message on the screen with the default label
func Ads() *Event {
	event := newDefaultEventWithLevel(levels.LevelAds)
	event.setLevelMetadata(levels.LevelAds)
	return event
}
